...
export default function SideBar() {
  ...
  useEffect(() => {
    const checkToken = async () => {
      if (restaurantData && restaurantData.merchant) {
        setNotificationStatus(restaurantData.merchant.enableNotification)
        if (
          restaurantData.merchant && restaurantData.merchant.enableNotification &&
        ...
        <View style={styles.topContainer}>
          <View style={styles.profileContainer}>
            <View style={styles.avatar}>
              <Image
                source={{ uri: data && data.merchant && data.merchant.image }}
            ...
            <View style={{ width: '50%' }}>
              <TextDefault
                ...
                {data && data.merchant && data.merchant.name}
              </TextDefault>
            </View>
          </View>
        </View>
